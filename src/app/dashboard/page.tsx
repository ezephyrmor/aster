      ...
      icon={
        ...
        >
          <path
            ...
            strokeWidth={2}
            d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 0 001 1h3m10-11l2 2m-2-2v10a1 0 01-1 1h-3m-6 0a1 0 001-1v-4a1 0 011-1h2a1 0 011 1v4a1 0 001 1m-6 0h6"
          />
        </svg>
      }
    >
      {/* Top Row: Welcome, Attendance, Calendar */}
                ...
                {attendanceStatus && !attendanceStatus.schedule && (
                  <div className="p-3 bg-amber-50 dark:bg-amber-900/20 rounded-lg border border-amber-200 dark:border-amber-800">
                    ...
                    <p className="text-xs text-amber-600 dark:text-amber-400">
                      Please contact your manager to set up your work schedule.
                    </p>
                  </div>
                )}
